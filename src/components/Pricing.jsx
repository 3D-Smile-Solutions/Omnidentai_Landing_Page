    ...
    <section ref={sectionRef} className={`pricing ${isDarkMode ? 'dark' : 'light'}`}>
      <section className="pricing-sticky">
        ...
        <div className="pricing-cards" ref={cardContainerRef}>
          {/* Core Platform Card - Shows FIRST on mobile, CENTER on desktop */}
          <div 
            ref={card2Ref} 
          ...
          {/* Built In Card - Shows SECOND on mobile, LEFT on desktop */}
          <div 
            ref={card1Ref} 
          ...
          {/* Optional Card - Shows THIRD on mobile, RIGHT on desktop */}
          <div 
            ref={card3Ref} 
